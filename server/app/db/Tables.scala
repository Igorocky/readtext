...
class TopicTable(tag: Tag) extends Table[Topic](tag, "TOPICS") {
  ...
  def * = (id.?,         paragraphId.?, checked, title,  order, images) <> (
    (t: (  Option[Long], Option[Long],  Boolean, String, Int,   String)) =>
      Topic(t._1, t._2, t._3, t._4, t._5).setImages(t._6),
    (t: Topic) => Some((t.id, t.paragraphId, t.checked, t.title, t.order, t.imagesStr))
  )
}
